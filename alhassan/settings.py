...
# إعدادات خاصة للملف التنفيذي
if getattr(sys, 'frozen', False):
    # التطبيق يعمل كملف تنفيذي
    BASE_DIR = Path(sys.executable).parent
    # إضافة مسار الملفات المؤقتة
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            TEMP_DIR / 'templates' if getattr(sys, 'frozen', False) and 'TEMP_DIR' in locals() else BASE_DIR / 'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if getattr(sys, 'frozen', False):
    STATICFILES_DIRS = [
        BASE_DIR / 'static',
        TEMP_DIR / 'static' if 'TEMP_DIR' in locals() else BASE_DIR / 'static',
    ]
